const c={manual30:[{name:"Reliance Controls 310CRK",desc:"30A, 10-circuit complete kit",price:"$280-$350",badge:"Best Overall",url:"https://www.amazon.com/dp/B000HS2L3O?tag=112233445504b-20"},{name:"Reliance Controls 306LRK",desc:"30A, 6-circuit kit",price:"$170-$220",badge:"Budget Pick",url:"https://www.amazon.com/dp/B013SG7K4Q?tag=112233445504b-20"}],manual50:[{name:"Reliance Controls 510CRK",desc:"50A, 10-circuit kit",price:"$350-$420",badge:"Best 50A",url:"https://www.amazon.com/dp/B00PPCPZGC?tag=112233445504b-20"}],autoGenerac:[{name:"Generac 6853 Home Link",desc:"30A manual, upgradeable to auto",price:"$320-$380",badge:"Best for Generac",url:"https://www.amazon.com/dp/B00V4NDG12?tag=112233445504b-20"}],autoOther:[{name:"Reliance Controls 310CRK",desc:"30A 10-circuit complete kit",price:"$280-$350",badge:"Most Popular",url:"https://www.amazon.com/dp/B000HS2L3O?tag=112233445504b-20"}]};document.querySelectorAll('input[name="gen-type"]').forEach(n=>{n.addEventListener("change",r=>{const a=r.target.value==="standby";document.getElementById("brand-section").classList.toggle("hidden",!a),document.getElementById("outlet-section").classList.toggle("hidden",a)})});document.getElementById("check-btn")?.addEventListener("click",()=>{const n=document.querySelector('input[name="gen-type"]:checked')?.value,r=document.getElementById("gen-brand")?.value,a=parseInt(document.getElementById("gen-watts")?.value||"0"),g=document.getElementById("gen-outlet")?.value,i=document.getElementById("panel-size")?.value,o=document.querySelector('input[name="switch-type"]:checked')?.value;if(!a||!i){alert("Please fill in all required fields");return}let p=!0,t=[],s=[];const l=a/240;let d=l<=30?30:l<=50?50:100;o==="automatic"&&n==="portable"&&t.push("Automatic transfer switches are designed for standby generators. Consider a manual switch for portable generators."),n==="standby"&&o==="manual"&&t.push("Standby generators typically use automatic transfer switches for convenience."),g==="L5-30"&&t.push("L5-30 outlets (3-prong) may require a neutral-ground bonding plug for some transfer switches."),l>parseInt(i)&&(p=!1,t.push(`Your generator output (${Math.round(l)}A) exceeds your panel capacity (${i}A).`)),n==="portable"?s.push(`A ${d}A manual transfer switch is ideal for your setup.`):r==="generac"?s.push("Generac generators work best with Generac automatic transfer switches."):s.push("Consider a universal automatic transfer switch or consult with your generator manufacturer.");const b=p?`<div class="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
